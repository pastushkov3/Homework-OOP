...
first_student = Student("Илья", "Пастушков", "м")
first_student.finished_courses += ["ABAP"]
first_student.courses_in_progress += ["GIT"]
first_student.courses_in_progress += ["Python"]

second_student = Student("Дмитрий", "Волик", "м")
second_student.courses_in_progress += ["Python"]
second_student.finished_courses += ["C#"]

first_lecturer = Lecturer("Иван", "Петров")
first_lecturer.courses_attached += ["Python"]
first_lecturer.courses_attached += ["GIT"]

second_lecturer = Lecturer("Виталий", "Бодров")
second_lecturer.courses_attached += ["GIT"]

first_reviewer = Reviewer("Антон", "Носов")
first_reviewer.courses_attached += ["Python"]

second_reviewer = Reviewer("Юрий", "Стоянов")
...
print(f"Средняя оценка за дз у Пастушкова больше, чем у Волика {second_student < first_student}")
print(f"Средняя оценка за лекции у Бодрова меньше, чем у Петрова {second_lecturer < first_lecturer}\n")
